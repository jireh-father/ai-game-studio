...
const FlowMixin = {
  ...
  onWaveClear() {
    ...
    // Track wave clear achievement
    AchievementManager.addStat('total_waves', 1);
    AchievementManager.addStat('max_chain', this.maxChainDepth);
    const achNew = AchievementManager.checkUnlocks();
    achNew.forEach(a => this.fx.achievementToast(a.label));
  ...
  gameOver() {
    ...
    // Track game played achievement
    AchievementManager.addStat('total_games', 1);
    AchievementManager.addStat('max_chain', this.maxChainDepth);
