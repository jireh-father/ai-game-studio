...
const SPECIES = [
    // --- 10 regular mobs ---
    species({ id: 'blob',    name: 'Blob',    kind: 'mob', radius: 46, hpMult: 1.0, speed: 70,  move: 'amble',   goldMult: 1.0, attack: 'melee' },
        { body: '#7dffb2', belly: '#5fdd94', face: 'happy',  accessory: 'none' }),
    species({ id: 'mini',    name: 'Mini',    kind: 'mob', radius: 26, hpMult: 0.5, speed: 150, move: 'zigzag',  goldMult: 0.8, attack: 'melee' },
        { body: '#ff9ad5', belly: '#e878b8', face: 'grin',   accessory: 'none' }),
    species({ id: 'tank',    name: 'Tank',    kind: 'mob', radius: 64, hpMult: 4.0, speed: 36,  move: 'amble',   goldMult: 2.2, attack: 'slam' },
        { body: '#6fa8ff', belly: '#5388e0', face: 'angry',  accessory: 'horns' }),
    species({ id: 'zippy',   name: 'Zippy',   kind: 'mob', radius: 34, hpMult: 0.8, speed: 120, move: 'dash',    goldMult: 1.2, attack: 'charge' },
        { body: '#ffe066', belly: '#e8c44a', face: 'grin',   accessory: 'none' }),
    species({ id: 'scaredy', name: 'Scaredy', kind: 'mob', radius: 38, hpMult: 1.0, speed: 95,  move: 'flee',    goldMult: 1.5, attack: 'none' },
        { body: '#c7a4ff', belly: '#a984e8', face: 'scared', accessory: 'none' }),
    species({ id: 'pudding', name: 'Pudding', kind: 'mob', radius: 54, hpMult: 2.0, speed: 55,  move: 'amble',   goldMult: 1.6, attack: 'slam' },
        { body: '#ffb066', belly: '#e8944a', face: 'happy',  accessory: 'none' }),
    species({ id: 'drop',    name: 'Drop',    kind: 'mob', radius: 30, hpMult: 0.7, speed: 110, move: 'zigzag',  goldMult: 1.0, attack: 'spray' },
        { body: '#66e0e0', belly: '#4ac4c4', face: 'happy',  accessory: 'none' }),
    species({ id: 'blinky',  name: 'Blinky',  kind: 'mob', radius: 40, hpMult: 1.2, speed: 80,  move: 'sleeper', goldMult: 1.3, attack: 'zap' },
        { body: '#9aa5c0', belly: '#7e89a4', face: 'sleepy', accessory: 'zzz' }),
    species({ id: 'twins',   name: 'Twins',   kind: 'mob', radius: 36, hpMult: 0.9, speed: 85,  move: 'amble',   goldMult: 1.1, attack: 'melee' },
        { body: '#a8e05f', belly: '#8cc443', face: 'grin',   accessory: 'none' }),
    species({ id: 'grumpy',  name: 'Grumpy',  kind: 'mob', radius: 50, hpMult: 1.6, speed: 60,  move: 'dash',    goldMult: 1.5, attack: 'charge' },
        { body: '#ff7d7d', belly: '#e05e5e', face: 'angry',  accessory: 'none' }),

    // --- 10 v1.1 newcomers: cuter, weirder, trickier ---
    species({ id: 'ghosty',  name: 'Ghosty',  kind: 'mob', radius: 38, hpMult: 1.0, speed: 60,  move: 'amble',    goldMult: 1.8, attack: 'zap', quirk: 'phase' },
        { body: '#dfe6ff', belly: '#b9c4f0', face: 'sleepy', accessory: 'none', alpha: 0.8 }),
    species({ id: 'hoppy',   name: 'Hoppy',   kind: 'mob', radius: 34, hpMult: 0.9, speed: 115, move: 'hop',      goldMult: 1.2, attack: 'melee' },
        { body: '#ffc7de', belly: '#eaa5c4', face: 'grin',   accessory: 'ears' }),
    species({ id: 'orbity',  name: 'Orbity',  kind: 'mob', radius: 36, hpMult: 1.1, speed: 85,  move: 'orbit',    goldMult: 1.3, attack: 'spit' },
        { body: '#9fd0ff', belly: '#7fb2e8', face: 'happy',  accessory: 'ring' }),
    species({ id: 'lovey',   name: 'Lovey',   kind: 'mob', radius: 34, hpMult: 0.8, speed: 70,  move: 'chase',    goldMult: 1.4, attack: 'melee' },
        { body: '#ffa3b8', belly: '#e88399', face: 'love',   accessory: 'heart' }),
    species({ id: 'rocky',   name: 'Rocky',   kind: 'mob', radius: 30, hpMult: 0.7, speed: 220, move: 'ricochet', goldMult: 1.6, attack: 'charge' },
        { body: '#ffb84a', belly: '#e0982e', face: 'grin',   accessory: 'flame' }),
    species({ id: 'bubbly',  name: 'Bubbly',  kind: 'mob', radius: 40, hpMult: 0.8, speed: 55,  move: 'float',    goldMult: 1.2, attack: 'spit' },
        { body: '#a3ecff', belly: '#7fd2ea', face: 'happy',  accessory: 'bubble' }),
    species({ id: 'shysh',   name: 'Shysh',   kind: 'mob', radius: 38, hpMult: 1.0, speed: 90,  move: 'amble',    goldMult: 1.7, attack: 'none', quirk: 'shy' },
        { body: '#c9e89a', belly: '#a9cc78', face: 'scared', accessory: 'leaf' }),
    species({ id: 'cloney',  name: 'Cloney',  kind: 'mob', radius: 36, hpMult: 1.3, speed: 80,  move: 'amble',    goldMult: 1.8, attack: 'zap', quirk: 'blink' },
        { body: '#e0b3ff', belly: '#c391ea', face: 'wink',   accessory: 'sparkle' }),
    species({ id: 'freezy',  name: 'Freezy',  kind: 'mob', radius: 42, hpMult: 1.4, speed: 45,  move: 'amble',    goldMult: 1.6, attack: 'spit', quirk: 'ice' },
        { body: '#bfe8ff', belly: '#98cdf0', face: 'sleepy', accessory: 'ice' }),
    species({ id: 'chunky',  name: 'Chunky',  kind: 'mob', radius: 68, hpMult: 6.0, speed: 28,  move: 'amble',    goldMult: 3.0, attack: 'slam' },
        { body: '#ffd08a', belly: '#e8b165', face: 'happy',  accessory: 'none' }),

    // --- 4 specials ---
    species({ id: 'splitter', name: 'Splitter', kind: 'splitter', radius: 44, hpMult: 1.2, speed: 75, move: 'amble', goldMult: 1.2, attack: 'melee', childId: 'mini' },
        { body: '#baff66', belly: '#9ce04a', face: 'grin',   accessory: 'splitline' }),
    species({ id: 'shieldy',  name: 'Shieldy',  kind: 'shield',   radius: 48, hpMult: 1.5, speed: 50, move: 'amble', goldMult: 2.0, attack: 'slam' },
        { body: '#8fb8d0', belly: '#739cb4', face: 'angry',  accessory: 'shell' }),
    species({ id: 'goldie',   name: 'Goldie',   kind: 'jackpot',  radius: 36, hpMult: 1.0, speed: 240, move: 'flee', goldMult: 10, attack: 'none', despawnMs: 6000 },
        { body: '#ffd54a', belly: '#e8b82e', face: 'greedy', accessory: 'coin' }),
    species({ id: 'king',     name: 'King Jelly', kind: 'boss',   radius: 240, hpMult: 1.0, speed: 25, move: 'amble', goldMult: 1.0, attack: 'slam' },
        { body: '#b06fff', belly: '#9350e0', face: 'angry',  accessory: 'crown' })
];

// =============================================================================
// v2.1 - PET ANIMALS: 50 adorable round critters, painted parametrically.
// Element counters: fire > leaf > water > fire; electric neutral (chain).
// =============================================================================
...
function animal(id, name, element, body, belly, earIn, ear, pattern, mouth, extra) {
    return {
        id, name, element,
...
// 50 critters. Elements spread ~evenly (fire/electric/water/leaf).
const PET_SPECIES = [
    animal('cat',      'Cat',      'fire',     '#ffb066', '#ffd9b0', '#e8894a', 'pointy', 'none',    'w',     'whiskers'),
    animal('dog',      'Dog',      'leaf',     '#c9a06a', '#ecd9b8', '#a5732e', 'floppy', 'patch',   'open',  'tail'),
    animal('rabbit',   'Rabbit',   'leaf',     '#f5e6e8', '#ffffff', '#ffb6c8', 'long',   'none',    'w',     'none'),
    animal('bear',     'Bear',     'fire',     '#b98050', '#e0c09a', '#8a5a30', 'round',  'none',    'smile', 'none'),
    animal('panda',    'Panda',    'leaf',     '#f5f5f5', '#ffffff', '#2a2a34', 'round',  'mask',    'smile', 'none'),
    animal('fox',      'Fox',      'fire',     '#ff8a4a', '#ffe0c0', '#d06020', 'pointy', 'none',    'w',     'tail'),
    animal('pig',      'Pig',      'water',    '#ffb0c0', '#ffd0da', '#e88a9e', 'pointy', 'none',    'open',  'none'),
    animal('frog',     'Frog',     'water',    '#7ec850', '#c5e8a5', '#5aa032', 'round',  'none',    'smile', 'none'),
    animal('chick',    'Chick',    'electric', '#ffe066', '#fff2b8', '#ffb547', 'tuft',   'none',    'beak',  'none'),
    animal('penguin',  'Penguin',  'water',    '#3a4a63', '#ffffff', '#28344a', 'none',   'belly',   'beak',  'wing'),
    animal('koala',    'Koala',    'leaf',     '#a8b0bd', '#d8dde5', '#8890a0', 'round',  'none',    'smile', 'none'),
    animal('tiger',    'Tiger',    'fire',     '#ffab3d', '#ffe0b0', '#c87818', 'round',  'stripes', 'w',     'whiskers'),
    animal('lion',     'Lion',     'fire',     '#ffc36a', '#ffe6bd', '#d08830', 'round',  'none',    'w',     'mane'),
    animal('mouse',    'Mouse',    'electric', '#c8c8d5', '#e8e8f0', '#ffb6c8', 'round',  'none',    'w',     'whiskers'),
    animal('hamster',  'Hamster',  'electric', '#ffcf8a', '#fff0d5', '#e8a050', 'round',  'patch',   'open',  'none'),
    animal('duck',     'Duck',     'water',    '#fff2b8', '#ffffff', '#ffd75e', 'none',   'none',    'beak',  'wing'),
    animal('owl',      'Owl',      'leaf',     '#b08860', '#e5d0b0', '#7d5a38', 'tuft',   'mask',    'beak',  'none'),
    animal('wolf',     'Wolf',     'water',    '#9aa5b8', '#d5dce8', '#6d7a90', 'pointy', 'none',    'w',     'none'),
    animal('deer',     'Deer',     'leaf',     '#d8a878', '#f0ddc0', '#b0824e', 'floppy', 'spots',   'smile', 'antler'),
    animal('sheep',    'Sheep',    'leaf',     '#f8f2ea', '#ffffff', '#e0d5c5', 'floppy', 'none',    'smile', 'none'),
    animal('cow',      'Cow',      'leaf',     '#f5f5f0', '#ffffff', '#3a3a44', 'floppy', 'spots',   'open',  'horn'),
    animal('monkey',   'Monkey',   'fire',     '#b08055', '#ecd0a8', '#8a5a30', 'round',  'none',    'open',  'tail'),
    animal('elephant', 'Elephant', 'water',    '#b8c0d5', '#dde2f0', '#98a0b8', 'floppy', 'none',    'smile', 'tusk'),
    animal('raccoon',  'Raccoon',  'electric', '#a8a8b8', '#dcdce8', '#454550', 'pointy', 'mask',    'w',     'tail'),
    animal('hedgehog', 'Hedgehog', 'leaf',     '#c09468', '#ecd9b8', '#7d5a38', 'tuft',   'spots',   'w',     'none'),
    animal('squirrel', 'Squirrel', 'fire',     '#d5854a', '#f5d5ae', '#a5601e', 'pointy', 'none',    'open',  'tail'),
    animal('otter',    'Otter',    'water',    '#a5825f', '#e5d0b0', '#7d5a38', 'round',  'none',    'w',     'whiskers'),
    animal('seal',     'Seal',     'water',    '#c5d5e5', '#eef4fa', '#a0b5c8', 'none',   'spots',   'w',     'whiskers'),
    animal('dolphin',  'Dolphin',  'water',    '#7fb8e8', '#c5e2f8', '#4a90c8', 'fin',    'belly',   'smile', 'none'),
    animal('whale',    'Whale',    'water',    '#6a9ad5', '#b8d5f0', '#4a78b0', 'fin',    'belly',   'smile', 'none'),
    animal('turtle',   'Turtle',   'leaf',     '#8ac878', '#c8e8b8', '#5a9548', 'none',   'shell',   'smile', 'none'),
    animal('snail',    'Snail',    'leaf',     '#e8c880', '#f5e5c0', '#c89850', 'antenna','shell',   'smile', 'none'),
    animal('bee',      'Bee',      'electric', '#ffd75e', '#fff0b8', '#3a3a44', 'antenna','stripes', 'smile', 'wing'),
    animal('ladybug',  'Ladybug',  'fire',     '#ff6b6b', '#ffb8b8', '#3a3a44', 'antenna','spots',   'smile', 'none'),
    animal('butterfly','Butterfly','electric', '#c7a4ff', '#e8dcff', '#9a6fe0', 'antenna','none',    'smile', 'wing'),
    animal('bat',      'Bat',      'electric', '#8a7aa8', '#c0b5d5', '#5d4d78', 'pointy', 'none',    'open',  'wing'),
    animal('crab',     'Crab',     'water',    '#ff8a70', '#ffc5b5', '#e05a3a', 'antenna','none',    'w',     'none'),
    animal('octopus',  'Octopus',  'water',    '#e88ab8', '#f5c5dd', '#c85a90', 'none',   'spots',   'w',     'none'),
    animal('axolotl',  'Axolotl',  'water',    '#ffb5c5', '#ffdde5', '#ff8aa5', 'tuft',   'none',    'smile', 'none'),
    animal('dragon',   'Dragon',   'fire',     '#ff7d5c', '#ffc5b0', '#d05030', 'horn',   'belly',   'open',  'tail'),
    animal('unicorn',  'Unicorn',  'electric', '#f0e5ff', '#ffffff', '#ffb6dd', 'fin',    'none',    'smile', 'sparkle'),
    animal('gecko',    'Gecko',    'leaf',     '#a5e05f', '#d5f0b0', '#78b038', 'none',   'spots',   'smile', 'tail'),
    animal('skunk',    'Skunk',    'leaf',     '#4a4a58', '#e8e8f0', '#f0f0f5', 'pointy', 'stripes', 'w',     'tail'),
    animal('goat',     'Goat',     'fire',     '#e5ddd0', '#f8f4ec', '#c0b5a0', 'floppy', 'none',    'smile', 'horn'),
    animal('horse',    'Horse',    'fire',     '#c08858', '#ead0ae', '#8a5a30', 'pointy', 'none',    'smile', 'mane'),
    animal('alpaca',   'Alpaca',   'leaf',     '#f5e8d5', '#fdf8ee', '#e0c8a5', 'long',   'none',    'w',     'none'),
    animal('toucan',   'Toucan',   'electric', '#3a3a48', '#f5f5f0', '#ff9a3d', 'none',   'belly',   'beak',  'wing'),
    animal('jellyfish','Jellyfish','electric', '#b8d5ff', '#e0edff', '#8aa8e8', 'antenna','none',    'smile', 'none'),
    animal('chameleon','Chameleon','leaf',     '#78d0a0', '#c0ecd5', '#48a870', 'fin',    'stripes', 'smile', 'tail'),
    animal('redpanda', 'Red Panda','fire',     '#e0784a', '#f5c5a5', '#8a4020', 'round',  'mask',    'w',     'tail')
];
