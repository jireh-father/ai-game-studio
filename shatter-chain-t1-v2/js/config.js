...
const CFG = {
  ...
  COLOR: {
    ...
    GOLDEN: 0xFFD700,
    GOLDEN_HEX: '#FFD700',
    GOLDEN_GLOW: 0xFFF8DC,
    ABSORBER: 0x8B0000,
    ABSORBER_HEX: '#8B0000',
    ABSORBER_PULSE: 0xFF2222,
  },
  ...
  GOLD_RUSH_MULTIPLIER: 3,
  GOLDEN_MOVE_WAVE: 8,
  GOLDEN_MOVE_AMP: 40,
  GOLDEN_MOVE_SPEED: 0.8,

  // Screen Crack
  CRACK_DEPTH4_LINES: 5,
  CRACK_DEPTH5_LINES: 12,
  CRACK_FADE_MS: 250,
  CRACK_SHIFT_PX: 2,
  SHATTER_OVERLAY_OFFSET: 8,
  SHATTER_OVERLAY_TRIANGLES: 6,

  // Ball Personality
  BALL_AIM_SQUASH_X: 0.8,
  BALL_AIM_STRETCH_Y: 1.2,
  BALL_IMPACT_SQUASH_X: 1.3,
  BALL_IMPACT_SQUASH_Y: 0.7,
  BALL_IMPACT_DURATION: 60,
  BALL_CLEAR_SPIN: 720,
  BALL_CLEAR_DURATION: 400,
  BALL_IDLE_THRESHOLD: 3000,
  BALL_IDLE_HOP: 8,
  BALL_IDLE_HOP_MS: 150,
};
...
function playGoldRush() { [523, 659, 784, 1047].forEach((f, i) => setTimeout(() => playTone(f, 100, 'sine', 0.15), i * 60)); }
function playAbsorberConvert() { playTone(150, 300, 'sawtooth', 0.12); setTimeout(() => playTone(100, 200, 'sawtooth', 0.10), 150); }
function playAbsorberKill() { playTone(80, 200, 'sawtooth', 0.15); }
