...
// --- v2: Combo Spectacle + Dramatic Moments ---
const LAST_STAND = {
  HEARTBEAT_MS: 800,
  ZOOM: 1.05,
  SCORE_MULT: 2,
  ...
  HEAL_AMOUNT: 1,
  COMEBACK_COLOR: '#00FF88'
};

const FINISHING_BLOW = {
  HITSTOP_MS: 350,
  ZOOM: 1.08,
  SHAKE_INTENSITY: 0.012,
  PARTICLE_COUNT: 45,
  CRITICAL_BONUS: 500,
  GOLD_BORDER_FLASH: 0xFFD700
};
...
const COMBO_ANNOUNCER = {
  5:  { text: 'NICE!',         color: '#FFFFFF', style: 'bounce' },
  10: { text: 'AMAZING!',      color: '#FFD700', style: 'slam' },
  15: { text: 'INCREDIBLE!',   color: '#FF8C00', style: 'spin' },
  20: { text: 'UNBELIEVABLE!', color: '#FF3030', style: 'shake' },
  25: { text: 'LEGENDARY!',    color: '#9B59B6', style: 'scaleHuge' },
  30: { text: 'GODLIKE!',      color: '#FF00FF', style: 'rainbow' }
};

const COMBO_ANNOUNCE_DURATION = 600;
