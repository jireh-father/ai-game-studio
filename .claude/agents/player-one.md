...
name: player-one
model: sonnet
description: Player experience tester - tests fun factor via Playwright
---
...
All screenshots MUST be saved to `./tmp/` directory. Create the directory if it doesn't exist. Use descriptive filenames: `./tmp/{slug}-{context}.png` (e.g., `./tmp/alarm-slap-title.png`, `./tmp/alarm-slap-death.png`).
