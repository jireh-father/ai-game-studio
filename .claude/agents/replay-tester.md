...
name: replay-tester
model: sonnet
description: Replay tester - tests replayability via Playwright
---
...
All screenshots MUST be saved to `./tmp/` directory. Create the directory if it doesn't exist. Use descriptive filenames: `./tmp/{slug}-rt-{context}.png`.
